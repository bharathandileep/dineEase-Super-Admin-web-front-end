...
export const generateKitchenNotification = async (userId: string | undefined, kitchenName: string | undefined) => {
    try {
...
export const getAllNotifications = async (query:any)=>{
    ...
    export const generateOrganizationNotification = async (userId: string | undefined, organizationName: string | undefined) => {
        try {
            const response = await axiosInstance.get(
