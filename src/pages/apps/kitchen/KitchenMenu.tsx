...
// import { Accordion, Button, Tabs, Tab, Card } from "react-bootstrap";
...
const KitchenMenu = () => {
  ...
  const handleProceedToCheckout = async () => {
    ...
    setLoading(true);
    try {
      const hardcodedKitchenId = "67aec000bcaa1d5aae09a661";
    ...
    <>
      ...
      >
        <div className="d-flex align-items-center justify-content-between">
          ...
          <Link
            to={`/apps/kitchen/${id}/our-menu`}
            className="btn btn-danger waves-effect waves-light"
          >
            <i className="mdi mdi-plus-circle me-1"></i> View Current Menu
          </Link>
        </div>
      </div>
