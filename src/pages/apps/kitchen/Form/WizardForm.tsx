  ...
  const validateStep3 = () => {
    ...
    if (formData.working_days.length === 0) {
      ...
      formData.working_days.forEach((day, index) => {
        if (!day.day)
          newErrors[`working_days.${index}.day`] = "Day is required";
        if (day.is_open) {
          if (!day.open_time)
            newErrors[`working_days.${index}.open_time`] =
    ...
    if (formData.pre_ordering_options.length > 0) {
      formData.pre_ordering_options.forEach((option, index) => {
        ...
        if (!option.meal_type)
          newErrors[`pre_ordering_options.${index}.meal_type`] =
                            ...
                            <div className="col-md-3">
                              <div className="form-group">
                                ...
                                <select
                                  ...
                                  className={`form-select ${
                                    errors[
                                      `working_days.${index}.day` as keyof FormData
                                    ]
                                      ? "is-invalid"
                                      : ""
                                  }`}
                            ...
                            <div className="col-md-2">
                              <div className="form-group">
                                ...
                                <select
                                  ...
                                  className={`form-select ${
                                    errors[
                                      `pre_ordering_options.${index}.day` as keyof FormData
                                    ]
                                      ? "is-invalid"
                                      : ""
                                  }`}
                            ...
                            <div className="col-md-2">
                              <div className="form-group">
                                ...
                                <select
                                  ...
                                  className={`form-select ${
                                    errors[
                                      `pre_ordering_options.${index}.meal_type` as keyof FormData
                                    ]
                                      ? "is-invalid"
                                      : ""
                                  }`}
