...
interface Kitchen {
  ...
  subcategoryDetails: { // Adjusted to match schema and backend response
    _id: string;
    subcategoryName: string; // Changed from subcategoryName to match backend aggregation
    category: string;
  };
}
      ...
      if (response.status) {
        ...
        if (isNewSearch) {
          ...
          setKitchens((prev) => {
            ...
            const newItems = (fetchedKitchens || []).filter(
                      ...
                      <div className='product-info mt-auto'>
                        ...
                        <div className='text-muted font-14'>
                          ...
                          {/* <div className='d-flex align-items-center text-black'>
                            ...
                            <span>
                              {item.categoryDetails?.category} - {item.subcategoryDetails?.subcategoryName}
                            </span>
                          </div> */}
                        </div>
                      </div>
